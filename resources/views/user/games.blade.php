...
<body>
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="user/img/page-top-bg/1.jpg">
		<div class="page-info">
			<h2>Games</h2>
				...
				<div class="col-xl-7 col-lg-8 col-md-7">
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="user/img/games/1.jpg" alt="#">
								<h5>Zombie Appocalipse 2</h5>
								<a href="game-single.html" class="read-more">Read More  <img src="user/img/icons/double-arrow.png" alt="#"/></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="game-item">
								<img src="user/img/games/2.jpg" alt="#">
								<h5>Dooms Day</h5>
								<a href="game-single.html" class="read-more">Read More  <img src="user/img/icons/double-arrow.png" alt="#"/></a>
							</div>
						</div>
	...
	<section class="featured-section">
		<div class="featured-bg set-bg" data-setbg="user/img/featured-bg.jpg"></div>
