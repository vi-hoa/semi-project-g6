...
<body>
	...
	<!-- Page top section -->
	<section class="page-top-section set-bg" data-setbg="user/img/page-top-bg/2.jpg">
		<div class="page-info">
			<h2>Reviews</h2>
		...
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="review-pic">
							<img src="user/img/review/1.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
			...
			<div class="review-item">
				<div class="row">
					<div class="col-lg-4">
						<div class="review-pic">
							<img src="user/img/review/2.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
						<div class="review-content text-box text-white">
			...
			<div class="review-item">
				<div class="row">
					<div class="col-lg-4">
						<div class="review-pic">
							<img src="user/img/review/3.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
						<div class="review-content text-box text-white">
			...
			<div class="review-item">
				<div class="row">
					<div class="col-lg-4">
						<div class="review-pic">
							<img src="user/img/review/4.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
						<div class="review-content text-box text-white">
			...
			<div class="review-item">
				<div class="row">
					<div class="col-lg-4">
						<div class="review-pic">
							<img src="user/img/review/5.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
						<div class="review-content text-box text-white">
